...
function ProfileForm() {
  ...
  //   Axios.get("http://localhost:4000/getUserDetails/" + user.id).then(
  //     (response) => {
            ...
            <form>
              <div className="section">
                ...
                <div className="profile-pic">
                  <img width="200px" src={"/Users/Images/" + userImage} alt="image" ></img>
                </div>
              ...
              <div className="section">
                ...
                <input onChange={(event) => { setUserName(event.target.value); }} type="text" id="name" />
              </div>
